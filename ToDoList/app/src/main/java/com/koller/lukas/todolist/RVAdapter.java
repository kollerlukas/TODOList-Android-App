...
public class RVAdapter extends RecyclerView.Adapter<RVAdapter.EventViewHolder> {
    ...
    public static class EventViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
        ...
        public void editButtonClicked() {
            ...
            edit_anim.setColorFilter(new ThemeHelper(context).getEventTextColor(event.getColor()), PorterDuff.Mode.SRC_ATOP);
            edit_anim.start();

            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    edit_button.setBackgroundResource(R.drawable.edit_button_background);
                    edit_button.getBackground().setColorFilter(new ThemeHelper(context).getEventTextColor(event.getColor()), PorterDuff.Mode.SRC_ATOP);
        ...
        public void alarmButtonClicked() {
            ...
            alarm_anim.setColorFilter(new ThemeHelper(context).getEventTextColor(event.getColor()), PorterDuff.Mode.SRC_ATOP);
            alarm_anim.start();

            new Handler().postDelayed(new Runnable() {
                public void run() {
                    alarm_button.setBackgroundResource(R.drawable.alarm_button_background);
                    alarm_button.getBackground().setColorFilter(new ThemeHelper(context).getEventTextColor(event.getColor()), PorterDuff.Mode.SRC_ATOP);
        ...
        public void collapse_noAnimation(){
            ...
            card_action_view.setVisibility(View.GONE);
            event.setIs_expanded(false);
        }

        public void collapse() {
            if (!is_expanding_or_collapsing && !event.semi_transparent && event.is_expanded) {
        ...
        public void colorCard(int color_index) {
            setColor(new ThemeHelper(context).getEventColor(color_index), new ThemeHelper(context).getEventTextColor(color_index));
        }

        public void setCardSemiTransparent(int color_index) {
            setColor(new ThemeHelper(context).getEventColor_semitransparent(color_index), new ThemeHelper(context).getEventTextColor_semitransparent(color_index));
        ...
        private void setColor(int color, int textColor) {
            ...
            color_button.getBackground().setColorFilter(textColor, PorterDuff.Mode.SRC_ATOP);
            edit_button.getBackground().setColorFilter(textColor, PorterDuff.Mode.SRC_ATOP);
            alarm_button.getBackground().setColorFilter(textColor, PorterDuff.Mode.SRC_ATOP);
        }
        ...
        public void updateCard() {
            ...
            if((event.is_expanded && card_action_view.getVisibility() == View.GONE) || (!event.is_expanded && card_action_view.getVisibility() == View.VISIBLE)){
    ...
    RVAdapter(ArrayList<EVENT> events, CardButtonOnClickHelper onClickHelper, Context context) {
        this.events = events;
